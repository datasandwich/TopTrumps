...
namespace TopTrumps.Controllers
{
    public class CardsController : Controller
    {
        ...
        public CardsController(DeckDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Attr1,Attr2,Attr3,Attr4,Attr5")] Card card)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Attr1,Attr2,Attr3,Attr4,Attr5")] Card card)
        {
            if (id != card.ID)
            {
                return NotFound();
